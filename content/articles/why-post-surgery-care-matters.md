...
reviewed: true
references:
  - title: "Wound Healing After Oral and Maxillofacial Surgery: Phases and Timeline"
    url: "https://pubmed.ncbi.nlm.nih.gov/28349426/"
  - title: "Long-Term Outcomes Following Tooth Extraction: Socket Filling and Ridge Resorption"
    url: "https://pubmed.ncbi.nlm.nih.gov/31844574/"
  - title: "Post-Surgical Complications and Preventive Factors in Oral Surgery"
    url: "https://pubmed.ncbi.nlm.nih.gov/30084283/"
  - title: "Impact of Patient Compliance with Post-Operative Instructions on Outcomes"
    url: "https://pubmed.ncbi.nlm.nih.gov/32271606/"
  - title: "Smoking, Alcohol, and Post-Surgical Healing: Evidence-Based Guidelines"
    url: "https://pubmed.ncbi.nlm.nih.gov/25532538/"
  - title: "Systemic Disease and Post-Operative Healing: Risk Assessment and Modification"
    url: "https://pubmed.ncbi.nlm.nih.gov/27647033/"
  - title: "Return to Function Timeline Following Oral and Maxillofacial Surgery"
...
**Simple Extraction:** Minimal post-operative care required; hemorrhage control (gauze), swelling management (ice, elevation), and pain management (NSAIDs) enable rapid recovery. Return to normal diet by day 3-5; normal activities by day 1-3.

**Surgical Third Molar Extraction:** Requires aggressive post-operative management; alveolar osteitis prevention through chlorhexidine rinses, smoking avoidance, and gentle socket handling during extraction. Pain management requires scheduled NSAIDs plus opioids as needed (first 3-5 days). Swelling management essential (ice first 24 hours, heat thereafter, elevation). Suture removal at 7-10 days. Full recovery requires 2-4 weeks.

**Bone Grafting/Implant Placement:** Extended surgical time and tissue manipulation require intensive post-operative care. Graft site protection through primary closure enables optimal integration. Sutures remain in place 10-14 days; graft protection maintained beyond epithelialization (2-3 weeks). Full bone remodeling requires 3-6 months; implant loading deferred until osseointegration completion (3-6 months).

**Orthognathic (Jaw Correction) Surgery:** Major procedure requiring hospitalization/extensive monitoring; pain management involves opioids (first 1-2 weeks), NSAIDs, and acetaminophen. Swelling management requires extended protocol (3-6 weeks for substantial resolution). Diet liquid (first week), soft (weeks 2-4), progression to normal by 6-8 weeks. Physical function recovery requires 4-8 weeks; return to sport/strenuous activity 8-12 weeks.
