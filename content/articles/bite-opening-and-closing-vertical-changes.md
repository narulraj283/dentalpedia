...
references:
  ...
  - "Baccetti T, McGill JS, Franchi L, McNamara JA, Tollaro I. Skeletal effects of early treatment of anterior open bite with functional appliances. American Journal of Orthodontics and Dentofacial Orthopedics. 1998;113(3):268-275."
  - "Opdebeeck H, van den Meulen S. A transverse maxillary widening procedure in growing subjects. American Journal of Orthodontics. 1978;74(3):270-281."
...
Thumb-sucking is the classic culprit in children. The sucking habit prevents front teeth from erupting (coming in normally), the tongue thrusts forward to fill the gap, and the whole problem perpetuates. Open bite typically starts when kids begin sucking (ages 2-4). If the habit stops by age 7-8, about 60-70% of cases close spontaneously within 6-12 months as teeth erupt normally. But if sucking continues beyond age 10, only 30-40% close spontaneously — the jaw growth pattern has become entrenched.

Tongue thrust (abnormal swallowing where the tongue presses into front teeth instead of pressing the palate) perpetuates open bite once established. Even if sucking stops, tongue thrust keeps pushing teeth apart during every swallow. This requires speech therapy (tongue thrust exercises retraining swallowing patterns) combined with orthodontics — braces alone can't fix it if the tongue keeps pushing.
...
The first step is stopping the habit (if there is one). Stopping thumb-sucking in early childhood, with positive reinforcement and encouragement, leads to 60-70% of cases closing spontaneously within 6-12 months as teeth erupt normally. Speech therapy correcting tongue thrust (teaching proper swallowing) is essential for complete correction — without it, open bite tends to return.
...
Growing adolescents benefit most because back teeth naturally want to erupt. Your orthodontist simply guides that eruption with special elastics (vertical elastics from upper front to lower back) that pull back teeth down while allowing front teeth to move up. This leverage achieves 2-4 millimeters vertical dimension increase in 8-12 months.

For adults (non-growing patients), intrusion (moving front teeth up) becomes necessary. This requires heavy, continuous force (200-400 grams) for 6-12 months achieving 0.5-1.0 millimeter monthly movement upward. Root resorption (permanent root shortening) occurs in 30-40% of intrusion cases — an unavoidable risk. Modern orthodontists prefer combining some front tooth movement with whatever back tooth eruption is possible, minimizing intrusion duration and reducing root resorption risk.

Severe skeletal deep bite requires jaw surgery, typically maxilla (upper jaw) repositioning downward and forward, directly correcting the low-angle jaw pattern.

## Stability After Correction

Open bite shows 15-25% relapse rate even with good retention — teeth tend to shift back toward the original open space partly because the underlying high-angle jaw pattern continues pushing vertically. Good retention (bonded wire plus removable retainers worn 3-5 nights weekly indefinitely) prevents most relapse, but some degree of reopening over years is realistic.

Deep bite shows better stability — about 95% stability with good retention and 6-month retention protocols. Skeletal changes stabilize better than dental changes. However, some relapse occurs over decades due to natural aging, wear, and continued jaw remodeling.
