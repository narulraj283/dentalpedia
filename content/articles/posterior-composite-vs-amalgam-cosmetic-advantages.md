...
date: 2026-03-05
excerpt: 'For decades, back tooth fillings meant only one thing: silver amalgam. It
  was durable, easy to place, and lasted a long time.'
read_time: 12 min
references:
- title: 'Soncini JA, Maserejian NN, Trachtenberg F, Tavares M, Hayes C. The longevity
    of amalgam versus composite restorations in posterior primary and permanent teeth:
...
- title: da Rosa Rodolpho PA, Donassollo TA, Cenci MS, et al. 22-year clinical evaluation
    of the performance of two posterior composite resins - longevity and reasons for
    failure. Dent Mater. 2016;32(2):e78-e85.
  url: https://pubmed.ncbi.nlm.nih.gov/26746858
- title: 'Vailati F, Vallittu PK, Boccaccini AR. Fiber-reinforced composites for posterior
    restorations: a comparison of materials and techniques. Dent Mater. 2018;34(4):594-602.'
  url: https://pubmed.ncbi.nlm.nih.gov/29395607
- title: 'Demarco FF, Corrêa MB, Cenci MS, Moraes RR, Opdam NJ. Longevity of posterior
    composite restorations: not only a matter of material. Dent Mater. 2012;28(1):87-101.'
  url: https://pubmed.ncbi.nlm.nih.gov/22119951
- title: van Dijken JWV, Hasselrot L. A prospective 15-year evaluation of extensive
    dentin-bonded and resin-modified glass-ionomer restorations in posterior teeth.
    Dent Mater. 2015;31(8):1019-1028.
...
Why does composite failure mode matter? When composites fail, they usually show marginal defects (small gaps at the edge) or surface wear. These are managed by replacement. When amalgams fail, they often develop secondary caries (decay beneath the restoration), which is more serious and may require more extensive retreatment. From a clinical perspective, composite failures are often simpler to manage.
...
**Self-etch systems** skip the separate etching step, using acidic adhesive that simultaneously etches and bonds. These simplify application but may produce slightly weaker enamel bonding unless combined with separate enamel etching. Modern evidence supports using phosphoric acid to etch enamel, then self-etch adhesive for dentin—combining the best of both approaches.
...
For cavities involving proximal surfaces (the sides of teeth), proper contact development is critical. Improper contacts create food traps, patient dissatisfaction, and interproximal cavity risk. Getting the contact right requires matrix band tension, careful material placement, and patient-specific adjustment.
...
Modern composite shade systems offer 20-30+ shade options matching virtually all natural tooth colors. Your dentist selects shade before rubber dam placement (rubber dam yellows the visual field, making shade selection inaccurate). Digital shade analysis helps some practices select objective shade matches.

Advanced shade selection considers not just the tooth's main color but also translucency, fluorescence, and subtle color variations. A composite that matches your tooth's main color might look artificial if it lacks proper translucency. Some composites include fluorescent particles matching natural tooth fluorescence, creating more natural appearance.

One clinical reality: composite polymerization shrinkage causes slight shade darkening (about 0.5-1 shade unit) post-operatively as the material shrinks and light transmission changes. Anticipating this darkening during shade selection helps ensure final esthetic outcomes match your expectations.
...
**Amalgam** is still a valid option for patients willing to tolerate visible restorations or those with heavy bites where composite failure risk is higher. [Amalgam has excellent longevity](/article/mercury-amalgam-controversy.html) and is significantly less technique-sensitive than composite.

**Glass ionomer** is less durable but releases fluoride and may be appropriate for very deep cavities or patients with high cavity risk.
