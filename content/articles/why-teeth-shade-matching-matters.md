---
title: Why Teeth Shade Matching Matters
...
reviewed: true
references:
  - title: "Accuracy of visual shade matching in fixed prosthodontics: systematic review"
    url: "https://pubmed.ncbi.nlm.nih.gov/18453633/"
  - title: "Spectrophotometry in dentistry: color measurement reliability and clinical application"
    url: "https://pubmed.ncbi.nlm.nih.gov/19233122/"
  - title: "Factors affecting color matching accuracy in adhesive restorations"
    url: "https://pubmed.ncbi.nlm.nih.gov/22278571/"
  - title: "Digital shade matching systems and inter-examiner reliability"
    url: "https://pubmed.ncbi.nlm.nih.gov/23658518/"
  - title: "Composite resin shade selection and masking ability of different shade groups"
    url: "https://pubmed.ncbi.nlm.nih.gov/16477760/"
  - title: "Optical properties of dental composite resins: effects on shade matching"
    url: "https://pubmed.ncbi.nlm.nih.gov/17570824/"
  - title: "Influence of material thickness and translucency on composite shade matching"
    url: "https://pubmed.ncbi.nlm.nih.gov/21263707/"
  - title: "Enamel and dentin contribution to tooth color in shade matching"
    url: "https://pubmed.ncbi.nlm.nih.gov/18453633/"
  - title: "Effect of substructure color on veneer shade selection and clinical outcomes"
    url: "https://pubmed.ncbi.nlm.nih.gov/19233122/"
...
Tooth color has three distinct properties: lightness (how bright or dark the tooth appears), hue (what color family it's in—yellow, orange, red, or gray), and saturation (how intense that color is). Your natural teeth likely have a yellowish or orangish undertone, not pure white. This is incredibly important because repairs selected without considering undertones often look too blue, gray, or unnaturally white—exactly what patients are trying to avoid.

## The Human Eye Problem: Why Visual Matching Often Falls Short

Here's the painful truth: human eyes are notoriously unreliable at color matching. When dentists use traditional shade guides (plastic tabs to compare colors), they typically match colors only 50–70% correctly. This is because human color perception is complicated by several psychological factors:
...
For cosmetic repairs, the best strategy is layering: using an opaque or dentin-colored base to mask any underlying discoloration, then an intermediate shade for bulk structure. Finally translucent materials at the surface to create natural light transmission. This approach creates repairs that look natural from any distance and angle because they mimic how natural teeth actually work.

Also, most natural teeth have subtle undertones (slightly yellow, orange, or red) rather than pure white or gray. Repairs selected without considering these undertones frequently look too blue, gray, or unnaturally white. This is why your dentist should show you the shade selection against your natural tooth under various lighting conditions—office lighting, natural daylight, and even warm incandescent—before finalizing the choice.

## Understanding Material Masking and Thickness

The final shade of your repair depends on how much underlying tooth structure shows through. Thin composite resin (less than 0.5 millimeters) lets significant color show through underneath. Thicker material (1.0–1.5 millimeters) provides moderate masking, while very thick material (2 millimeters or more) provides near-complete masking of discolored substrates.
...
After your repair is placed, assess the shade yourself under multiple lighting conditions before you completely leave the office:
...
If the shade is obviously mismatched in any lighting condition, mention it right away. Minor adjustments can sometimes be made. If significant mismatch exists, your dentist may need to remake the repair rather than settling for a poor match.
...
Composite resin repairs don't maintain their initial shade forever. Research shows average color changes of 2–4 shade units over 2–5 years, meaning your repair might gradually yellow, darken, or become stained. Some is from staining agents (coffee, tea, wine, tobacco), and some is from the material itself aging.

The good news: keeping shade requires the same habits you'd use to keep natural teeth bright. Minimize exposure to staining foods and beverages, maintain regular brushing and flossing, and visit your dentist twice yearly for expert cleanings. Surface polish and glazing can help maintain shine and even provide minor shade adjustments through light reflectance optimization.

## Questions for Your Dentist About Shade Matching

Before your repair is completed, ensure you understand the shade matching approach:
...
Perfect shade matching requires both proper technique and realistic expectations. Spectrophotometric measurement provides far superior accuracy compared to visual matching, but even then, slight variations may occur under different lighting. Layering techniques with varied material opacities create the most natural-looking repairs. Understanding the complexity helps you appreciate the artistry involved in creating seamless repairs that look like they belong in your mouth.
