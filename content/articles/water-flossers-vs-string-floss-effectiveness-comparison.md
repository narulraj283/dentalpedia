---
title: Water Flossers vs. String Floss Effectiveness Comparison
...
reviewed: true
references:
  - title: "Water Floss Efficacy for Interproximal Plaque Removal: Randomized Controlled Trial"
    url: https://pubmed.ncbi.nlm.nih.gov/17280638
  - title: "Water Jet Irrigation and Gingival Health: Clinical Outcomes in Gingivitis"
    url: https://pubmed.ncbi.nlm.nih.gov/17999839
  - title: "Comparison of Flossing Techniques on Interproximal Plaque Removal Efficacy"
    url: https://pubmed.ncbi.nlm.nih.gov/24801171
  - title: "Subgingival Biofilm Removal with Water Floss: Pressure and Flow Considerations"
    url: https://pubmed.ncbi.nlm.nih.gov/20797283
  - title: "Oral Irrigation and Peri-implantitis Prevention in Implant Patients"
    url: https://pubmed.ncbi.nlm.nih.gov/25699433
  - title: "Gingivitis Reduction with Water Floss Versus String Floss: Meta-Analysis"
    url: https://pubmed.ncbi.nlm.nih.gov/25701405
  - title: "Manual and Water-Powered Toothbrush Combined with Flossing Efficacy"
    url: https://pubmed.ncbi.nlm.nih.gov/21806283
  - title: "Compliance with Flossing Recommendations: Water Floss Versus String Floss"
    url: https://pubmed.ncbi.nlm.nih.gov/26255097
  - title: "Supragingival and Subgingival Biofilm Control with Oral Irrigation"
    url: https://pubmed.ncbi.nlm.nih.gov/24799060
...
To understand why water floss works so well, you need to know what plaque actually is. It's not just a simple layer of bacteria. It's a complex three-dimensional structure called a biofilm—a community of bacteria embedded in a sticky polysaccharide matrix with all sorts of organic material. String floss disrupts this biofilm mechanically by scraping it off tooth surfaces. This works reasonably well above the gumline and in accessible spaces between teeth, but it struggles with irregular areas and deep pockets.

Water floss uses a fundamentally different approach. The pulsating water stream disrupts the biofilm through multiple mechanisms: hydraulic force pushes the bacteria loose, pressure waves actually kill bacterial cells, and the water mechanically flushes away the disrupted biofilm. Crucially, water floss can penetrate below the gumline—into the pockets between your gum and tooth—reaching bacteria that string floss cannot access. In periodontal pockets (areas affected by gum disease), water floss penetrates 4-5 mm below the gumline, reaching biofilm completely inaccessible to string floss.

## The Pressure is Just Right

The effectiveness of water floss depends on proper pressure settings. Standard water flossers like Waterpik operate at 40-60 psi (pounds per square inch), which is proven effective without causing tissue damage. Higher pressures (over 100 psi) provide no additional benefit and risk harming your gum tissue. The pulsating nature—the rapid on-off cycling of the water stream—is important too, providing better biofilm disruption than a continuous stream at the same pressure.
...
People with limited manual dexterity—whether from arthritis, age, motor control issues, or just clumsiness—find water flossing much easier. The powered operation eliminates the fine motor skill requirement. You simply activate the device and aim it; you don't need the specific hand coordination that string flossing requires. This accessibility means higher compliance and better long-term results.
...
If you switch from string floss to water floss, expect to see improvement in your gum health within 2-4 weeks. Your gums might bleed less during flossing and brushing. Your breath might improve. Your dentist will notice less plaque and inflammation at your checkup. If you've been struggling with string flossing and not doing it consistently, the improvement from switching to water floss will be dramatic—like finally performing the oral hygiene routine your mouth actually needs.
