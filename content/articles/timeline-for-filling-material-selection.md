...
**Critical variables:**
1. **Acid-etch adhesive protocol:** Phosphoric acid etching creates micro-retentive surface; essential for composite retention
...
**5-year survival:** 80-90% for Class I/II
**10-year survival:** 70-85%; superior to conventional GIC; comparable to composite for Class V restorations
...
**Material hierarchy (best to acceptable):**
1. **Amalgam** (if posterior visible area minimal)
...
**Material hierarchy:**
1. **Amalgam** (posterior, not visible)
   - **Longevity:** 12-18 years; 95%+ 10-year survival
...
**Material hierarchy:**
1. **Composite** (direct restoration, single appointment)
...
**Material hierarchy:**
1. **RMGIC** (preferred for cervical lesions)
...
| Material | Class I/II 10-Yr Survival | Longevity | Esthetics | Strength | Cost |
|---|---|---|---|---|---|
| **Amalgam** | 95%+ | 12-18 yrs | Poor | Excellent | Low |
| **Composite** | 80-90% | 7-12 yrs | Excellent | Good | Moderate |
| **Bulk-Fill Composite** | ~85% | 7-12 yrs | Excellent | Good | Moderate-High |
| **Glass Ionomer** | 60-70% | 5-8 yrs | Fair | Poor | Low |
