...
date: 2026-03-05
excerpt: Noma is a rare but devastating mouth infection that affects malnourished
  children, particularly in developing countries.
read_time: 9 min
references:
- title: 'Noma (cancrum oris): pathogenesis and sequelae'
  url: https://pubmed.ncbi.nlm.nih.gov/14585133
- title: 'Noma: an infectious disease of poverty'
  url: https://pubmed.ncbi.nlm.nih.gov/12857646
- title: 'Necrotizing ulcerative gingivitis: a review'
...
In early stages, these symptoms might look like necrotizing ulcerative gingivitis (a serious gum infection), which is why nutritional support and antibiotics at this stage can prevent noma progression.
...
**Stage 1:** Gum inflammation, bleeding, and ulceration with foul-smelling breath. This stage might last weeks if untreated.

**Stage 2:** Rapid facial swelling appears. Dead tissue becomes visible in the mouth. Fever and systemic sickness worsen.

**Stage 3:** The infection has spread through facial tissues with visible opening to the face. Bone destruction occurs. This stage represents advanced, life-threatening disease.

**Stage 4:** If the child survives with treatment, severe scarring and contracture (tissue tightening) develops, creating permanent disfigurement and functional problems.
...
**Antibiotics:** Broad-spectrum antibiotics targeting the anaerobic bacteria causing the infection. Intravenous antibiotics are typically necessary in hospital settings.

**Surgical care:** Once acute infection is controlled (usually after 5-10 days of antibiotics and nutritional support), surgical removal of dead tissue is performed. Multiple staged surgeries might be necessary.
...
In regions where noma occurs, healthcare workers trained to recognize necrotizing ulcerative gingivitis (the precursor) and early noma signs can prompt urgent referral for treatment, potentially preventing progression.
