---
title: Risk and Concerns with Mouth Cleaning Tools
...
reviewed: true
references:
  - title: "Terezhalmy GT, Bsoul SA, Gmur R. The practice of human dentistry. 1st ed. St. Louis: Mosby; 2011."
    url: https://pubmed.ncbi.nlm.nih.gov/24619139
  - title: "Graziani F, Palazzi G, Sassi F, et al. Interdental brushing is able to reduce bleeding on probing without causing trauma to the interdental soft tissues. J Clin Periodontol. 2009;36(3):190-196."
    url: https://pubmed.ncbi.nlm.nih.gov/19207689
  - title: "Levin L, Shacham M, Brukstein B, Zeichner S, Lev-Dor R. Reducing dental erosion from water flosser use: an in vitro study. Quintessence Int. 2012;43(10):869-873."
    url: https://pubmed.ncbi.nlm.nih.gov/23034246
  - title: "Yaacob M, Worthington HV, Deacon SA, et al. Powered versus manual toothbrushing for oral health. Cochrane Database Syst Rev. 2014;6:CD002281."
    url: https://pubmed.ncbi.nlm.nih.gov/24913721
  - title: "Sälzer S, Slot DE, Van der Weijden FA, Dörfer CE. Efficacy of inter-dental mechanical plaque removal devices: a systematic review. J Dent Res. 2015;94(7):992-1000."
    url: https://pubmed.ncbi.nlm.nih.gov/25794702
  - title: "Rosema NA, Hennequin-Hoenderdos NL, Berchier CE, Slot DE, Lyle DM, Van der Weijden FA. The effect of different interdental cleaning devices on gingival bleeding. J Int Acad Periodontol. 2011;13(1):2-10."
    url: https://pubmed.ncbi.nlm.nih.gov/21491660
  - title: "Slot DE, Wiggelinkhuizen L, Rosema NA, Van der Weijden GA. The efficacy of manual toothbrushes following a brushing protocol: a systematic review. Int J Dent Hyg. 2012;10(3):187-197."
    url: https://pubmed.ncbi.nlm.nih.gov/22409240
  - title: "Kinney JM, Linde JV, Kaba S, Newman M. Anatomic variations of the soft tissues and alveolar bone around teeth. JADA. 1989;119(4):519-526."
    url: https://pubmed.ncbi.nlm.nih.gov/2807235
  - title: "Dyer D, Addy M, Newcombe RG. Studies in vitro of abrasion by different manual toothbrush heads and a standard toothpaste. J Clin Periodontol. 2000;27(2):99-103."
    url: https://pubmed.ncbi.nlm.nih.gov/10743864
...
Interdental brushes (small spiral brushes that fit between your teeth) are excellent for cleaning spaces between teeth, and they're often more effective than floss for people with wider gaps between teeth. However, if you choose a brush too large for your spaces, you'll damage your gums every time you use it. The brush should fit snugly without forcing, and you shouldn't have to push hard to insert it. If your spaces are very tight, forcing a large brush will cause gum trauma, recession, and pain. The advantage of interdental brushes is that many people find them easier to use and more effective than floss, so if you're struggling with flossing, talk to your dental hygienist about what size brush would work for your tooth spacing.
...
The paradox of oral hygiene is that tools designed to clean your teeth can damage your gums if misused. Your goal should be removing plaque gently and consistently rather than aggressively attacking your teeth and gums. The time you spend cleaning matters less than the technique—gentle, consistent cleaning for 2 minutes twice daily is better than aggressive scrubbing for 10 minutes. Watch your gums for signs of damage: persistent bleeding despite gentle technique, increasing gum recession, or increasing sensitivity to cold might mean you need to adjust your technique or try different tools. Your dentist and hygienist can watch for damage during checkups and recommend adjustments.
