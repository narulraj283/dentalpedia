...
subcategory_slug: patient-safety
references:
  - title: "Cross-contamination prevention in dental settings: CDC guidelines"
    url: https://www.ncbi.nlm.nih.gov/pubmed/24050123
  - title: "Instrument sterilization in dental practice: autoclaving protocols"
    url: https://www.ncbi.nlm.nih.gov/pubmed/23118198
  - title: "Bloodborne pathogens in dental practice: prevention and management"
...
**Hand hygiene:** Your dentist washes hands before seeing you and between patients. They might wear gloves and change gloves between procedures. Good hand hygiene is the foundation of infection control.

**Sterilization:** All instruments used in your mouth are sterilized in an autoclave (high-pressure steam sterilizer) between patients. This kills all microorganisms including bacterial spores, which are the hardest to kill and require the highest temperatures and pressures.

**Disposable items:** Items like gloves, masks, bibs, and suction tips are discarded after single use. They're never reused. You might see your dentist open new, sterile gloves for you, indicating attention to sterility.

**Operatory disinfection:** Between patients, the dental chair, light handles, instrument tray, and work surfaces are wiped with disinfectant solution. This prevents cross-contamination between patients.

**Masks and eye protection:** Your dentist wears a mask and protective eyewear to protect both of you. The mask prevents their respiratory droplets from contaminating your mouth; the eyewear protects them from splash-back.
