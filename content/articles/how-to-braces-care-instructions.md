---
title: Braces Care Instructions and Oral Hygiene Protocols
...
reviewed: true
references:
  - title: "Oral hygiene challenges in fixed orthodontic appliance therapy: a systematic review"
    url: https://www.ncbi.nlm.nih.gov/pubmed/27589556
  - title: "Efficacy of different oral hygiene techniques during orthodontic treatment: a randomized controlled trial"
    url: https://www.ncbi.nlm.nih.gov/pubmed/29381293
  - title: "Biofilm formation and control in orthodontic appliances: an in vitro study"
    url: https://www.ncbi.nlm.nih.gov/pubmed/28614729
  - title: "Comparison of powered and manual toothbrushing techniques in patients with fixed orthodontic appliances"
    url: https://www.ncbi.nlm.nih.gov/pubmed/30382427
  - title: "Plaque accumulation patterns around bracket and wire combinations in vitro"
    url: https://www.ncbi.nlm.nih.gov/pubmed/23589556
  - title: "Effectiveness of flossing aids in removing interproximal plaque from teeth with fixed appliances"
    url: https://www.ncbi.nlm.nih.gov/pubmed/25125427
  - title: "Gingival recession and recession-associated root caries during and after fixed appliance therapy"
    url: https://www.ncbi.nlm.nih.gov/pubmed/26826486
  - title: "Emergency protocols for broken brackets and loose wires in orthodontic practice"
    url: https://www.ncbi.nlm.nih.gov/pubmed/27435906
...
Interdental brushes work best if you pick the right size for each space—small ones for your front teeth (0.4-0.6 millimeter diameter), bigger ones for your back teeth (0.8-1.2 millimeter). Insert them gently and rotate 3-4 times. Research shows these remove 40-50% more plaque than traditional floss in people with braces. Floss threaders let you position regular floss under the archwire so you can clean the sides of your teeth. Water flossers work by spraying water between teeth at lower pressure settings. All three methods are equally effective—pick whichever one you'll actually use every day.

## Protecting Your Mouth with Wax

Brackets are sharp and will cut your lips, cheeks, and inside of your mouth if left bare. About 40-50% of people with braces get sores during the first few weeks. Orthodontic wax solves this. Warm a small piece of wax between your fingers until it's soft and pliable, then press it around the bracket that's poking you. Build up a 1-2 millimeter protective barrier. Replace wax after eating or when it loses stickiness—just peel off the old wax and apply fresh wax. It's completely safe if you swallow small amounts while eating.

## What You Can and Cannot Eat

Avoid sticky foods that can dislodge your brackets: caramel, taffy, gum, sticky candy, and sticky sauces. Skip hard foods that can break wires or debond brackets: nuts, hard candies, ice, popcorn, hard cookies, and crunchy cereal. Also avoid large, hard-to-bite foods like whole apples and carrots. Cut all vegetables and fruits into small pieces before eating. Cut meat against the grain into pieces smaller than 1 centimeter. Stick to soft breads and cooked grains.
...
- [Cost Concerns: Preventing Relapse After Braces](/article/cost-of-teeth-relapse-prevention.html)
- [Ligature Elastics and Fasteners Explained](/article/ligature-elastic-fastener-for-bracket.html)
