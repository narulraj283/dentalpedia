...
### Mechanism and Application Timeline

Dental sealants are polymeric materials (typically resin-based composites) applied to occlusal surfaces of posterior teeth to physically block access to pit and fissure anatomy where bacteria and food debris accumulate. Placement timeline is typically from age 6 (upon eruption of first permanent molars) through age 14 (when second molars erupt). The mechanical barrier provided by sealants reduces caries incidence in sealed surfaces by 80-90%.

The application procedure involves acid-etching of the enamel surface with 37-40% phosphoric acid for 15-30 seconds to create microscopic etching patterns that enhance micromechanical retention of the sealant material. The sealant is then applied and polymerized with visible blue light. Proper moisture control and technique are critical—saliva contamination during etching or application significantly reduces sealant retention and effectiveness.

### Retention and Clinical Outcomes

Resin sealants show retention rates of 90% at 1 year, 70-80% at 3 years, and 50-60% at 5 years. Glass ionomer sealants provide lower retention (approximately 50% at 2 years) but may be preferable in poor moisture control situations because of their ability to function while partially retained. The caries benefit persists even when sealants are partially lost due to residual mechanical blocking and remineralization of etched enamel surfaces.
