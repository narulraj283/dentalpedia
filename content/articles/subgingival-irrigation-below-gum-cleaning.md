---
title: Subgingival Irrigation - Below Gum Cleaning and Antimicrobial Delivery
...
**Clinical Attachment Gain**: The primary outcome measure in periodontal therapy, clinical attachment gain, improves by approximately 0.5-1.0 mm when irrigation is added to SRP, particularly in deeper pockets (>5 mm).

**Bleeding on Probing**: Addition of irrigation to SRP reduces bleeding on probing by approximately 10-15% compared to SRP alone, suggesting improved tissue health and reduced inflammation.

**Bacterial Reduction**: Microbiologic samples obtained 4 weeks post-therapy demonstrate 50-70% reduction in target periodontal pathogens (P. gingivalis, T. forsythia) with irrigation + SRP, compared to 30-40% reduction with SRP alone.
...
**Timing**: Irrigation should be performed after mechanical instrumentation (SRP or ultrasonic scaling) to allow mechanical disruption of biofilm prior to antimicrobial delivery.

**Technique**:
1. Identify pockets ≥4 mm probing depth requiring irrigation
2. Insert irrigation needle or nozzle to approximately 80-90% of pocket depth (not forcing apically)
3. Express solution while withdrawing slowly from apical to coronal direction
4. Repeat for all periodontal pockets requiring treatment
5. Apply 3-5 mL of antimicrobial solution per session
